# Migration `20190810102140-init`

This migration has been generated by Mike Johnson at 8/10/2019, 10:21:40 AM.
...
You can use a specific Photon built for this migration (20190810102140-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190810102140-init'
